...
function Modal() {
    ...
    // Function for uploading a post, firebase stuff
            ...
            <Dialog as='div' className='fixed z-10 inset-0 overflow-y-auto'
                ...
                <div className="flex items-end justify-center min-h-[800px] sm:min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
                    ...
                    <Transition.Child
                        ...
                        leaveTo="opacity-0 tranlate-y-4 sm:translate-y-0 sm:scale-95"
                    >
                         ...
                         alt="" />
                             ...
                             <div>
                                 <div className="mt-3 text-center sm:mt-5">
                                    <Dialog.Title
                                    as="h30" className="text-lg leading-6 font-medium text-gray-900">
                                Upload a photo
                                    </Dialog.Title>
